...
# this data has some curvature and the residuals are unevenly distributed, meaning that a linear model may not be the best fit
...
tidy(phosphateMod)
# there is a weak negative relationship between increased distance from shore and concentration of phosphate. There is a 1.4% chance that we would get the same values if the null hypotheses were true and there was no relationship between phosphate and distance from shore
